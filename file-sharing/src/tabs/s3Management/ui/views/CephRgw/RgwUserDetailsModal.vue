<template>
    <div v-if="modelValue" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
        <div class="bg-default rounded-lg shadow-xl max-w-2xl w-full mx-4 overflow-hidden border border-gray-200">
            <!-- Header -->
            <div class="px-5 py-4 border-b border-gray-200 flex items-center justify-between bg-accent">
                ...
                <button class="text-xs px-3 py-1.5 rounded border border-gray-300 bg-secondary hover:bg-gray-100"
            ...
            <div class="px-5 py-4 space-y-4 text-sm max-h-[70vh] overflow-y-auto">
                ...
                <div v-else-if="user">
                    ...
                    <div class="flex flex-wrap items-center gap-2 text-[11px] mb-1">
                        <span class="inline-flex items-center rounded-full px-2 py-0.5 border text-xs" :class="user.suspended
                        ...
                        <span v-if="user.capacityLimitPercent != null"
                            class="inline-flex items-center rounded-full px-2 py-0.5 border border-gray-200 bg-accent text-gray-700">
                            Quota size:
                            <span class="ml-1 font-medium">{{ user.capacityLimitPercent }} KiB</span>
                        </span>

                        <span v-if="user.objectLimitPercent != null"
                            class="inline-flex items-center rounded-full px-2 py-0.5 border border-gray-200 bg-accent text-gray-700">
                            Quota objects:
                    ...
                    <section class="mt-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs">
                            <div class="border border-gray-200 rounded-lg px-3 py-2">
                                ...
                                <div class="font-medium">
                                    {{
                                        user.userQuotaMaxSizeKb != null
                                            ? user.userQuotaMaxSizeKb
                                    : "Unlimited / not set"
                                    }}
                                </div>
                            </div>
                    ...
                    <section class="mt-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs">
                            <div class="border border-gray-200 rounded-lg px-3 py-2">
                                ...
                                <div class="font-medium">
                                    {{
                                        user.bucketQuotaMaxSizeKb != null
                                            ? user.bucketQuotaMaxSizeKb
                                    : "Unlimited / not set"
                                    }}
                                </div>
                            </div>
                            <div class="border border-gray-200 rounded-lg px-3 py-2">
                                ...
                                <div class="font-medium">
                                    {{
                                        user.bucketQuotaMaxObjects != null
                                            ? user.bucketQuotaMaxObjects
                                    : "Unlimited / not set"
                                    }}
                                </div>
                            </div>
                    ...
                    <section class="mt-4" v-if="user.caps && user.caps.length">
                        ...
                        <div class="border border-gray-200 rounded-lg overflow-hidden ">
                            <table class="min-w-full border-collapse text-xs">
                                ...
                                <tbody>
                                    <tr v-for="(c, idx) in user.caps" :key="c.type + ':' + c.perm + ':' + idx"
