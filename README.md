...
```bash
curl -LO https://github.com/45Drives/cockpit-file-sharing/releases/download/v3.2.2/cockpit-file-sharing_3.2.2-1focal_all.deb
sudo apt install ./cockpit-file-sharing_3.2.2-1focal_all.deb
```
## Rocky 8
...
```bash
# dnf or yum
sudo dnf install https://github.com/45Drives/cockpit-file-sharing/releases/download/v3.2.2/cockpit-file-sharing-3.2.2-1.el8.noarch.rpm
```
...
```bash
curl -LO https://github.com/45Drives/cockpit-file-sharing/releases/download/v3.2.2/cockpit-file-sharing_3.2.2_generic.zip
unzip cockpit-file-sharing_3.2.2_generic.zip
cd cockpit-file-sharing_3.2.2_generic
