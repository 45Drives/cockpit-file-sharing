...
```bash
curl -LO https://github.com/45Drives/cockpit-file-sharing/releases/download/v4.0.0/cockpit-file-sharing_4.0.0-2focal_all.deb
sudo apt install ./cockpit-file-sharing_4.0.0-2focal_all.deb
```
## Rocky 8
...
```bash
# dnf or yum
sudo dnf install https://github.com/45Drives/cockpit-file-sharing/releases/download/v4.0.0/cockpit-file-sharing-4.0.0-2.el8.noarch.rpm
```
