...
```bash
curl -LO https://github.com/45Drives/cockpit-file-sharing/releases/download/v4.6.2/cockpit-file-sharing_4.6.2-1jammy_all.deb
sudo apt install ./cockpit-file-sharing_4.6.2-1jammy_all.deb
```
## Rocky 8, Rocky 9
### From 45Drives Repo (Recommended)
```bash
...
```bash
# dnf or yum
sudo dnf install https://github.com/45Drives/cockpit-file-sharing/releases/download/v4.6.2/cockpit-file-sharing-4.6.2-1.el9.noarch.rpm
```
